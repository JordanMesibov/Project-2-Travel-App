// enclosing module in function to export

function mainFunction(city1Input, city2Input, city3Input, city4Input, city5Input) {
...
function grabCitiesFromGroup() {
  ...
  // NOTE: cities will be pulled from the database in voteController.js and passed as arguments to this function

  city1Name = city1Input;
  city2Name = city2Input;
  city3Name = city3Input;
  city4Name = city4Input;
  city5Name = city5Input;
  //*******************/
